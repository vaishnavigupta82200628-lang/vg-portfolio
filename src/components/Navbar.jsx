...
const Navbar = () => {
  ...
  const hireMeMailto = `mailto:vaishnavigupta82200628@gmail.com?subject=Hiring Inquiry – Portfolio&body=Hello Vaishnavi,%0D%0A%0D%0AI came across your portfolio and would like to discuss an opportunity with you.%0D%0A%0D%0ALooking forward to hearing from you.%0D%0ABest Regards,`;
  return (
    <nav 
        ...
        <div className="flex flex-col px-6 space-y-4">
          ...
          <div className="pt-4 pb-2">
             <a 
               href={hireMeMailto}
               onClick={() => setIsOpen(false)} 
               className="inline-block px-6 py-3 rounded-full bg-white text-[#7c3aed] font-black hover:bg-black hover:text-white transition-colors w-full text-center shadow-lg"
             >
               Hire Me
             </a>
          </div>
